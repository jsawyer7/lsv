class TextPayload < ApplicationRecord
  ...
  def self.ransackable_attributes(auth_object = nil)
    ["payload_id", "unit_id", "language", "script", "edition_id", "layer", "content", "meta", "checksum_sha256", "source_id", "license", "version", "created_at", "updated_at"]
  end

  def self.ransackable_associations(auth_object = nil)
    ["text_unit", "source_registry"]
  end
end
