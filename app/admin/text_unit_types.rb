ActiveAdmin.register TextUnitType do
  ...
  index do
    div class: "page-header mb-4" do
      div class: "d-flex justify-content-between align-items-start" do
        div do
          h1 "Text Unit Type Management", class: "mb-2"
          para "Manage text unit types (Chapter, Verse, Surah, Ayah, etc.)", class: "text-muted"
        end
        div do
          link_to "Add Text Unit Type", new_admin_text_unit_type_path, class: "btn btn-primary"
        end
    ...
    table class: "table table-striped table-hover" do
      ...
      tbody do
        text_unit_types.each do |text_unit_type|
          tr do
            td do
              span class: "badge bg-primary" do text_unit_type.code end
            end
            td do
              span class: "fw-semibold" do text_unit_type.name end
            end
            td do
              span class: "text-muted" do text_unit_type.description || "No description" end
            end
            td class: "text-end" do
              div class: "btn-group" do
                link_to "View", admin_text_unit_type_path(text_unit_type), class: "btn btn-sm btn-outline-primary"
                link_to "Edit", edit_admin_text_unit_type_path(text_unit_type), class: "btn btn-sm btn-outline-secondary"
              end
            end
          end
        end
        ...
        div class: "d-flex justify-content-between align-items-center" do
          div do
            ...
            p class: "mb-0 opacity-75" do
              if f.object.new_record?
                "Add new text unit type"
              else
                "Update text unit type information"
              end
            end
          end
          link_to "Back to Text Unit Types", admin_text_unit_types_path, class: "btn btn-light"
        end
      end
      ...
      div class: "card-body p-5" do
          ...
          div class: "materio-form-group" do
            ...
            f.input :code,
                    ...
                    input_html: {
                      ...
                      placeholder: "Enter unit type code (e.g., BIB_CHAPTER, BIB_VERSE, QUR_SURA)..."
                    }
          end
          div class: "materio-form-group" do
            div class: "materio-form-label" do
            ...
            f.input :name,
                    ...
                    input_html: {
                      class: "materio-form-control",
                      style: "width: 100%; max-width: 500px;",
                      placeholder: "Enter unit type name (e.g., Chapter, Verse, Surah, Ayah)..."
                    }
          end
          div class: "materio-form-group" do
            div class: "materio-form-label" do
            ...
            f.input :description,
                    ...
                    input_html: {
                      class: "materio-form-control",
                      style: "width: 100%; max-width: 500px;",
                      placeholder: "Enter description (e.g., 'Used for all chapter-based sources')...",
                      rows: 3
                    }
          end
        end
        div class: "mt-4 pt-4 border-top" do
          div class: "d-flex justify-content-end gap-3" do
            if f.object.new_record?
              button "Create Text Unit Type", type: "submit", class: "btn btn-primary"
            else
              button "Update Text Unit Type", type: "submit", class: "btn btn-primary"
            end
            link_to "Cancel", admin_text_unit_types_path, class: "btn btn-outline-secondary"
          end
        end
      end
    end
  ...
  show do
    div class: "d-flex justify-content-between align-items-center mb-4" do
      div do
        h1 "Text Unit Type: #{resource.name}", class: "mb-1 fw-bold text-dark"
        p "Code: #{resource.code}", class: "text-muted mb-0"
      end
      div class: "d-flex gap-2" do
        link_to "Edit Text Unit Type", edit_admin_text_unit_type_path(resource), class: "btn btn-primary px-3 py-2"
        link_to "Back to Text Unit Types", admin_text_unit_types_path, class: "btn btn-outline-secondary px-3 py-2"
      end
    end
    ...
    div class: "row g-4" do
      ...
      div class: "col-lg-4" do
        div class: "materio-metric-card materio-metric-card-light" do
          ...
          h6 "Text Contents", class: "mb-2 fw-semibold"
          div class: "fw-bold text-dark mb-2" do resource.text_contents.count end
          p "Associated text contents", class: "text-muted small mb-0"
        end
      end
    end
  end
